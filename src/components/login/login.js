      ...
      <MDBContainer fluid>
              ...
              <MDBRow className='d-flex justify-content-center align-items-center h-100'>
                  <MDBCol col='12'>
                      ...
                      <MDBCard className='bg-white text-dark my-5 mx-auto' style={{ borderRadius: '1rem', maxWidth: '300px' }}>
                          <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>

                              <h2 className="fw-bold mb-2 text-uppercase">GNOSIS</h2>
                              <p className="text-dark-50 mb-5">Porfavor ingrese su cuenta y contrasena</p>
